...
<meta charset="utf-8" />
    ...
    <form action="../views/condominio/create.php?cond=true" method="POST" class="form-group">
        ...
        <input type="text" class="form-control" name="nome_cond">
        </div>
       	<div class="form-group col-md-6">
        <label>CNPJ</label>
        <input id="cnpj" type="numeric" class="form-control" name="cnpj">
        </div>
        </div>
        ...
        <div class="form-group col-md-6">
        <label>Número</label>
        <input type="numeric" class="form-control" name="num">
        </div>
        </div>
        ...
        <div class="form-group col-md-6">
        <label>Cidade</label>
        <input type="text" maxlength="14" class="form-control" name="cidade">
        </div> 
        <div class="form-group col-md-6">
        <label>CEP</label>
        <input id="cep" type="text" maxlength="14" class="form-control" name="cep">		</div> 
        </div>
