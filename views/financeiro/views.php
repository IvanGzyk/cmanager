                ...
                <div class="container-fluid">
                    ...
                    <div class="row p-3">
                        <div class="col-lg-6">
                            <div class="card mb-4">
                                <div class="card-header">
                                    <i class="fas fa-chart-bar mr-1"></i>Balanço financeiro <small>(últimos 30 dias)</small><button type="button" class="btn btn-info btn-sm float-right" data-toggle="modal" data-target="#extrato">EXTRATO DETALHADO</button></div>
                        ...
                        <div class="col-lg-6">
                            <div class="card mb-4">
                                <div class="card-header">
                                    <i class="fas fa-chart-area mr-1"></i>Acompanhamento de saldo <small>(últimos 6 meses)</small><button type="button" class="btn btn-info btn-sm float-right" data-toggle="modal" data-target="#extrato">EXTRATO DETALHADO</button></div>
